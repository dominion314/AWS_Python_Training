'''Explore possibilities of the birthday paradox.
...
# Set up a tuble of month names in order:

MONTHS = ('Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun',
'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec')

while True: # Keep asking until user enters a valid amount
    print('How many birthdays shale I generate (Max 100)')
    response = input('> ')
...
if match != None:
    ...
    print('Multiple people gave a birthday on', dateText)
else:
